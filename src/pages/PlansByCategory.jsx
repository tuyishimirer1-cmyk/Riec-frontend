...
export default function PlansByCategory() {
  ...
  const { data, isFetching } = useGetProjects(
    { page, pageSize, type: 'PLAN_TO_BUY', category: category?.toUpperCase() }
  )
  ...
  return (
    <>
      <Helmet>
        <title>{label} Plans | R.I.E.C</title>
        <meta name="description" content={`Browse all ${label} plans available for purchase by R.I.E.C`} />
      </Helmet>
        ...
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="py-6">
            <SearchBar
              ...
              placeholder={`Search ${label} plans…`}
              className="max-w-sm"
            />
          </div>
          ...
          {isFetching ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-slate-500">
              ...
              <p className="text-sm">No plans found{search ? ` for "${search}"` : ''}.</p>
            </div>
          ) : (
